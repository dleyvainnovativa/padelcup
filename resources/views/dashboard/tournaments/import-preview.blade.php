...
@section('content')
    ...
    <div class="tc-card mb-3">
        <div class="tc-card__head"><h3>Resumen por categoría</h3></div>
        <table class="tc-table">
            <thead>
                <tr><th>Categoría</th><th>Estado</th><th>Parejas</th><th>Jugadores</th></tr>
            </thead>
            <tbody>
    ...
    @if($newCats > 0)
        <p style="font-size:12px;color:var(--text-faint);margin-bottom:14px;">
            Las {{ $newCats }} categorías nuevas se crearán con formato <strong>Grupos + Eliminación</strong>, grupos de 3, 2 clasifican. Podrás ajustar cada una después de importar.
        </p>
    @endif
