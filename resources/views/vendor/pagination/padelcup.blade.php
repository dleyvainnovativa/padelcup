{{-- PadelCup themed paginator ("Linear meets Stripe", indigo #635bff).
     Use with {{ $paginator->links('vendor.pagination.padelcup') }} or set as the
     default in AppServiceProvider via Paginator::defaultView(). --}}
