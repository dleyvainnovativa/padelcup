...
<div class="pub-wrap" data-auto-refresh="60">
    ...
    {{-- Stats --}}
    <div class="pub-stats">
        <div class="pub-stat"><div class="pub-stat__n">{{ $stats['played'] }}</div><div class="pub-stat__l">Jugados</div></div>
        <div class="pub-stat"><div class="pub-stat__n">{{ $stats['won'] }}</div><div class="pub-stat__l">Ganados</div></div>
        <div class="pub-stat"><div class="pub-stat__n">{{ $stats['lost'] }}</div><div class="pub-stat__l">Perdidos</div></div>
        <div class="pub-stat"><div class="pub-stat__n pub-mono">{{ $stats['setsWon'] }}-{{ $stats['setsLost'] }}</div><div class="pub-stat__l">Games</div></div>
    </div>
