...
@section('title', 'Quiniela · ' . $tournament->name)
...
<div class="pub-wrap" style="padding: clamp(24px,4vw,44px) 20px;">
    ...
    <h1 style="font-size:clamp(24px,3.4vw,36px);font-weight:800;letter-spacing:-.02em;margin:0 0 6px;">
        <i class="fa-solid fa-wand-magic-sparkles" style="color:var(--lp-indigo);"></i> Quiniela
    </h1>
    ...
    @if(empty($rows))
        <div class="pp-empty">
            <i class="fa-solid fa-wand-magic-sparkles" style="font-size:28px;color:var(--text-faint);"></i>
