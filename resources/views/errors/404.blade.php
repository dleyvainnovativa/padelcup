...
<head>
    ...
    <title>Página no encontrada · PadelCup</title>
...
<body>
    <div class="err">
        ...
        <div class="err__icon"><i class="fa-solid fa-compass"></i></div>
        <p class="err__code">404</p>
        <h1 class="err__title">Página no encontrada</h1>
        <p class="err__msg">La página que buscas no existe o cambió de lugar. Revisa el enlace o vuelve al inicio.</p>
        <div class="err__btns">
