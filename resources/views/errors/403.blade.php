...
<head>
    ...
    <title>Acceso denegado · PadelCup</title>
...
<body>
    <div class="err">
        ...
        <div class="err__icon"><i class="fa-solid fa-lock"></i></div>
        <p class="err__code">403</p>
        <h1 class="err__title">Acceso denegado</h1>
        <p class="err__msg">No tienes permiso para ver esta página. Si crees que es un error, contacta al organizador.</p>
        <div class="err__btns">
